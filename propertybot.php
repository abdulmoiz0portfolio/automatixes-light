        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                ...
                <a href="https://wa.me/923366920141?text=Hello%20Automatixes%20Advisory%20Desk,%20I%20am%20inquiring%20about%20prime%20property%20consultation." 
                   target="_blank" 
                   rel="noopener" 
                   class="hidden md:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-950/60 hover:bg-emerald-900/60 border border-emerald-700/40 text-emerald-700 text-xs font-medium transition-all"
                ...
                <a href="index" class="px-3 py-1.5 rounded-lg border border-slate-300/80 bg-white/80 hover:bg-slate-100 text-slate-700 hover:text-white text-xs font-medium transition-all flex items-center gap-1.5">
        ...
        <div class="flex-1 flex flex-col rounded-2xl border border-slate-200/80 bg-white/40 backdrop-blur-md overflow-hidden shadow-2xl">
            ...
            <div class="px-4 py-3 bg-slate-50/70 border-t border-slate-200/70">
                ...
                <div class="overflow-x-auto whitespace-nowrap flex gap-2 pb-1 custom-scrollbar">
                    <button class="quick-prompt px-3 py-1.5 rounded-lg bg-white/90 hover:bg-emerald-50 hover:border-emerald-500/30 border border-slate-200 text-xs text-slate-800 hover:text-emerald-700 transition-all flex items-center gap-1.5 shrink-0" data-prompt="DHA aur Bahria Town me 1 Kanal plot ka kya rate chal raha hai?">
                        <i class="fa-solid fa-map-pin text-emerald-400 text-[11px]"></i>
                        <span>1 Kanal Benchmarks (DHA / Bahria)</span>
                    </button>
                    <button class="quick-prompt px-3 py-1.5 rounded-lg bg-white/90 hover:bg-emerald-50 hover:border-emerald-500/30 border border-slate-200 text-xs text-slate-800 hover:text-emerald-700 transition-all flex items-center gap-1.5 shrink-0" data-prompt="Property khareedne ke liye kon se documents zaroori hotay hain?">
                        <i class="fa-solid fa-file-shield text-blue-400 text-[11px]"></i>
                        <span>Required Documents (Fard / NOC)</span>
                    </button>
                    <button class="quick-prompt px-3 py-1.5 rounded-lg bg-white/90 hover:bg-emerald-50 hover:border-emerald-500/30 border border-slate-200 text-xs text-slate-800 hover:text-emerald-700 transition-all flex items-center gap-1.5 shrink-0" data-prompt="5 Marla ghar ke liye kitni down payment deni hogi?">
                        <i class="fa-solid fa-calculator text-amber-400 text-[11px]"></i>
                        <span>5 Marla Down Payment & Installments</span>
                    </button>
                    <button class="quick-prompt px-3 py-1.5 rounded-lg bg-white/90 hover:bg-emerald-50 hover:border-emerald-500/30 border border-slate-200 text-xs text-slate-800 hover:text-emerald-700 transition-all flex items-center gap-1.5 shrink-0" data-prompt="Commercial plots ka rental yield aur ROI kaisa hai?">
                        <i class="fa-solid fa-chart-line text-teal-400 text-[11px]"></i>
                        <span>Commercial vs Residential ROI</span>
                    </button>
                    <button class="quick-prompt px-3 py-1.5 rounded-lg bg-white/90 hover:bg-emerald-50 hover:border-emerald-500/30 border border-slate-200 text-xs text-slate-800 hover:text-emerald-700 transition-all flex items-center gap-1.5 shrink-0" data-prompt="Fard aur Intiqal me kya farq hota hai?">
                ...
                <form id="chat-form" class="flex items-center gap-2">
                    <div class="relative flex-1">
                        <input 
                            ...
                            class="w-full bg-white/90 border border-slate-300/80 rounded-xl px-4 py-3 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 shadow-inner"
                            autocomplete="off"
                        >
                    </div>
                    <button 
    ...
    <script>
        ...
        function sendWelcomeMessage() {
            ...
            msgEl.innerHTML = `
                ...
                <div class="max-w-[95%] sm:max-w-[85%]">
                    <div class="bg-white/90 border border-slate-200 text-slate-100 p-4 sm:p-5 rounded-2xl rounded-tl-none shadow-xl text-xs sm:text-sm leading-relaxed">
                        <div class="flex items-center justify-between mb-2">
        ...
        function sendConsultantMessage(markdownText) {
            ...
            msgEl.innerHTML = `
                ...
                <div class="max-w-[95%] sm:max-w-[85%]">
                    <div class="bg-white/90 border border-slate-200 text-slate-100 px-4 py-3.5 rounded-2xl rounded-tl-none shadow-md text-xs sm:text-sm leading-relaxed">
                        ${formattedContent}
                    </div>
                    <div class="text-[10px] text-slate-500 mt-1">${time}</div>
                </div>
